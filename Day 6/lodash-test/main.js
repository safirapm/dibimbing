...
// let arr = [ { n: 1 }, {n: 2} ];
// //ES6
// console.log('ES6', arr.map(x => x.n));
// // dia harus memakai function lagi untuk mengakseskey dalam object array arr

// // lodash
// console.log('lodash', _.map(arr, 'n')); // bisa langsung akses key dlm object tanpa menggunakan . lagi
